...
public class AffichageMenuFront {
    ...
    void rec(ActionEvent event) {
        try {
            Parent page1 = FXMLLoader.load(getClass().getResource("/ajouter.fxml"));
            Scene scene = new Scene(page1);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
    ...
    private void setChosenRec(Menu r) {
        ...
        try {
            image.setImage(new Image(new FileInputStream("C:\\xampp\\htdocs\\Integration\\src\\main\\resources\\Assets\\menu2.jpg")));
