...
public class Produit {
    ...
    public Produit(int id_produit, String nom_produit, String description_produit, String image_produit, double prix_produit, Entities.Menu menu, int like, int dislike) {
        this.id_produit = id_produit;
        this.nom_produit = nom_produit;
        this.description_produit = description_produit;
        this.image_produit = image_produit;
    ...
    public Produit(String nom_produit, String description_produit, String image_produit, double prix_produit, Entities.Menu menu, int like, int dislike) {
        this.nom_produit = nom_produit;
        this.description_produit = description_produit;
        this.image_produit = image_produit;
        this.prix_produit = prix_produit;
    ...
    public Produit(String nom_produit, String description_produit, String image_produit, double prix_produit , int idMenu) {
        this.nom_produit = nom_produit;
        this.description_produit = description_produit;
        this.image_produit = image_produit;
        this.prix_produit = prix_produit;
