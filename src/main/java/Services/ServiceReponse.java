...
public class ServiceReponse  implements IService <Reponse> {
    ...
    public void ajouter(Reponse r) {
        ...
        String req = "INSERT INTO `reponse_reclamation`(`Contenu`, `idRec`,`DateRep`) VALUES (?,?,?)";
        try {
            PreparedStatement ps = cnx.prepareStatement(req);
            ps.setString(1, r.getContenu());
            ps.setInt(2, r.getReclamation().getIdRec());
            ps.setDate(3, new java.sql.Date(r.getDateRep().getTime()));
            ps.executeUpdate();
