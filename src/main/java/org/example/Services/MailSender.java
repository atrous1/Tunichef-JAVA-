...
import javax.mail.internet.MimeMessage;
    ...
    public class MailSender {
        public static void sendMail(Reclamation reclamation ) throws Exception {
            String mailContent = "<!DOCTYPE html>\n"
                    ...
                    + "																							style=\"color:#2190e3;font-size:34px;\">"+reclamation.getDescription()+" "+reclamation.getAvis()+"</span></span></strong></span>\n"
                    + "																		</p>\n"
                    + "																	</div>\n"
                    + "																</div>\n"
                    + "															</td>\n"
                    ...
                    + "																				by : "+reclamation.getDescription()+"</span></p>\n"
                    + "																		<p\n"
                    ...
                    + "\n"
                    + "</html>";
            String myAccountEmail = "yassinelatrousy.l@gmail.com";
            String password = "cjdtzvwggyggefdt";
            ...
            Message message = prepareMessage(session, myAccountEmail, reclamation.getDescription(), mailContent);
